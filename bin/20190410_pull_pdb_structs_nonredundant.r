...
olea_template <- "4KU5" # previously 4KTI
oleas <- c("3S1Z", "3ROW", "5VXD", "5VXF", "5VXH", "6B2R", "6B2S", "6B2T", "6B2U", "3S20", "3S21", "5VXE", "5VXG", "5VXI", "3S23", "4KU3", "4KTI", "4KTM", "4KU2")
...
finres <- lapply(1:length(pdbfils), function(x) {
  extract_channels_super(pdbfils[grep("4KU5", pdbfils)], pdbfils[x]) })
